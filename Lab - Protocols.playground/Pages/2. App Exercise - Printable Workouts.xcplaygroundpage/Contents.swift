...
class Workout: CustomStringConvertible, Equatable, Comparable, Codable {
    ...
    var description: String {
        return "Fiz o exercício \(identifier) em \(time) horas, percorrendo \(distance) kilômetros"
    }
...
print(myWorkout)
// Fiz meu exercício <identifier> em <time>, percorrendo <distance> quilômetros
 ...
 */
let workouts = [myWorkout, myWorkout2]
...
if let jsonData = try? jsonEncoder.encode(myWorkout2) {
